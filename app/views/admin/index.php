            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $data['jml_member'] ?></div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-lg-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Peminjaman Belum Kembali</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $data['belum_kembali'] ?></div>
                    </div>
                    <div class="col-auto">
